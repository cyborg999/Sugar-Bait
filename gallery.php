...
<body>
    ...
    ?>
                     <div class='col-md-4 text-center' style='margin-bottom: 20px;'>
                        <img src="admin/gallery/<?php echo $row['image'];?>" width="200px" height="200px" alt=""  style="padding: 10px; border-radius: 40px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)">
                        <br>
                        <br>
                            ...
                            <div class="modal-body">
                              <div class="row">
                                    ...
                                    <div class="col-md-12 text-center">
                                      <img src="admin/gallery/<?php echo $row["image"]; ?>" width="200px" height="200px">
                                     <br>
                                     <br>
