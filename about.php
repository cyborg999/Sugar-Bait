       ...
       <div class="row">
        <nav class="navbar navbar-default navbar-static-top">
          <div class="container">
            ...
            <div class="col-md-12">
              <div class="col-md-4">
                <img src="image/candycart.png" alt="" style="width:300px; height: 400px">
              </div>
              <div class="col-md-4 text-center" >
                  <p style="font-size: 18px; padding-top: 20px">Everything started as a hobby and <br> loved for anything sweets.</p>
                  <br>
                   <img src="image/sblogo.png" alt="" style="width:250px; height: 200px">
                  <br>
                  <br>
                  <p>Two sisters created Candy Buffet in 2017</p>
              </div>
